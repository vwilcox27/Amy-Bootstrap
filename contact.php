...
<html lang="en">
  <head>
    ...
    <title>Contact - Small Cell Cervical Cancer - Start Bootstrap Template</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">Small Cell Cervical Cancer</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="about.html">About SCCC</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h3>Small Cell Cervical Cancer</h3>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            <p>Copyright Amy Wilcox for SCCC &copy; For All of Us :) 2014</p>
          </div>
        </div>
      </footer>
